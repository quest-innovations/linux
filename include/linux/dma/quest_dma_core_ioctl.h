...
#define QDMA_SET_CH_SIZE _IOW('q', 4, qdma_buf_arg_t *)

// Drives the reading of buffers (when not using IRQ)
#define QDMA_DRIVE_READ _IOR('q', 5, uint32_t *)

// Set and get register functions
#define QDMA_SETREG _IOW('q', 6, qdma_reg_arg_t *)
#define QDMA_GETREG _IOR('q', 7, qdma_reg_arg_t *)
